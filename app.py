...
def plot_candles(
    ...
    if highlight_offsets is None:
        highlight_offsets = [-2, -1, 0]
    highlight_idx = [p + off for off in highlight_offsets]
...
EVENTS_PATH = DATA_DIR / f"events__{ds_key}.parquet"
WEEKLY_PATH = DATA_DIR / f"weekly__{ds_key}.parquet"
